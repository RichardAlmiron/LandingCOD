...
export default function FilmStrip({ items, selectedId, onSelect, onConfirmSelect }: FilmStripProps) {
        ...
        <div className="flex items-center justify-center">
          {visibleItems.map((item, idx) => {
            ...
            return (
              ...
              >
                <div className="w-[280px] h-[350px] rounded-lg overflow-hidden shadow-2xl">
                  <LivePDPPreview 
                    templateId={item.id}
