...
export default function ProductCarousel3D({ 
  ...
  // Filter out empty src strings to avoid browser warnings
  ...
  return (
    <div style={{ padding: '0px' }} className="w-full h-full min-h-[350px] flex justify-center items-center overflow-visible">
      <div style={{
        position: 'relative', height: 450, width: '100%', overflow: 'visible',
      }}>
        {/* Arrows */}
        ...
        >
          <div
            ref={ringRef}
            style={{
              position: 'relative', width: 300, height: 350,
            ...
            {displayImages.map((src, i) => {
              ...
              return (
                <div
                  ...
                  className="group"
                  style={{
                    position: 'absolute', width: 300, height: 350,
