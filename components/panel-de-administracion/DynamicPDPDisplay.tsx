...
const FilmStrip = lazy(() => import('@/components/visualizacion/FilmStrip'));
const CoverFlow = lazy(() => import('@/components/visualizacion/CoverFlow'));
...
interface DynamicPDPDisplayProps {
  ...
  isAdmin?: boolean;
  onDeleteTemplate?: (id: string | string[]) => void;
