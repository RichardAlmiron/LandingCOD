          ...
          <div className="mb-20">
            ...
            <div className="flex overflow-x-auto gap-4 pb-8 snap-x snap-mandatory hide-scrollbar -mx-4 px-4 md:mx-0 md:px-0">
              {data.products.map(product => {
                ...
                return (
                  <div key={product.id} data-product-id={product.id} className="group cursor-pointer flex flex-col shrink-0 w-[240px] md:w-[280px] lg:w-[320px] snap-start hover:border-black transition-all border border-transparent pb-1">
