      ...
      <header className="bg-white sticky top-0 z-40 border-b-2 border-gray-100 transition-all h-[80px]">
        <div className="w-full mx-auto px-4 md:px-8 h-full flex items-center justify-between">
          ...
          <div className="flex items-center space-x-5 text-black">
            ...
            <div className="relative cursor-pointer hover:text-[#cc0000] transition-colors">
              <ShoppingBag className="w-6 h-6" />
              <span className="absolute -top-1.5 -right-2 bg-[#cc0000] text-white text-[10px] font-black px-1.5 rounded-full min-w-[18px] text-center border-2 border-white">0</span>
            </div>
          </div>
        </div>
      </header>
