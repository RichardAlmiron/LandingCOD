...
import { useTranslations, countryCodes } from '@/lib/translations';
...
import { X, Globe, Link as LinkIcon, ExternalLink, CheckCircle2, Loader2, Trash2, Store, LayoutTemplate, MousePointerClick, ChevronDown, Check } from 'lucide-react';
...
export default function BuilderFlow({ isAdmin }: { isAdmin?: boolean }) {
    ...
    const { t } = useTranslations(storeData.language || 'es');
                        ...
                        <div style={{ flex: 1, overflowY: 'auto', padding: '20px' }} className="custom-scrollbar">
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                                ...
                                <div className="section-elevated">
                                    <div className="section-title">{t('builder.language')}</div>
                                    <div className="language-selector">
                                        ...
                                        >
                                            ...
                                            <span className="lang-label">{t('builder.spanish')}</span>
                                        ...
                                        >
                                            <span className="lang-flag">🇧🇷</span>
                                            <span className="lang-label">{t('builder.portuguese')}</span>
                                    ...
                                    <div className="footer-simple">
                                        ...
                                        <div className="footer-contact-section">
                                            <div 
                                                ...
                                                onClick={() => {
                                                    if (!storeData.footerConfig?.contact?.enabled) {
                                            ...
                                            >
                                                <div className="contact-info">
                                                    ...
                                                    <div>
                                                        <div className="contact-title">{t('builder.contact')}</div>
                                                        <div className="contact-subtitle">
                                                            {storeData.footerConfig?.contact?.enabled ? t('builder.contactEnabled') : t('builder.contactDisabled')}
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            {/* Formulario de Contacto - Aparece cuando está activado y expandido */}
                                            {storeData.footerConfig?.contact?.enabled && isContactFormExpanded && (
                                                    ...
                                                    <div className="contact-input-group">
                                                        ...
                                                        <div className="phone-input-group">
                                                                        ...
                                                                        <div className="country-list">
                                                                            {countryCodes.map((country) => (
                                                                                ...
                                                                                >
                                                                                    ...
                                                                                    {selectedCountry.code === country.code && <Check className="w-4 h-4 check-icon" />}
                                                                                </button>
                                                                            ))}
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <input 
                                                                ...
                                                                value={storeData.footerConfig?.contact?.phone?.replace(selectedCountry.code, '').trim() || ''} 
                                                                onChange={e => {
                                                                    const phoneNumber = e.target.value.replace(/[^0-9\s]/g, '');
                                                                    setStoreData(p => ({ 
                                                                        ...p, 
                                                                        footerConfig: { 
                                                                            ...p.footerConfig, 
                                                                            contact: { ...p.footerConfig?.contact, phone: `${selectedCountry.code} ${phoneNumber}` } 
                                                                        } 
                                                                    }));
                                                                }}
                                                            />
                                                        ...
                                                        <button
                                                            ...
                                                            onClick={() => setIsContactFormExpanded(false)}
                                                        >
                                        ...
                                        <div className="section-elevated">
                                            <div className="section-title">{t('builder.socialMedia')}</div>
                                            <div className="social-inputs">
                                                <div className="input-with-icon">
                                                    ...
                                                    <input 
                                                        className="input-dark" 
                                                        placeholder={t('builder.facebook')}
                                                ...
                                                <div className="input-with-icon">
                                                    ...
                                                    <input 
                                                        className="input-dark" 
                                                        placeholder={t('builder.instagram')}
                                                ...
                                                <div className="input-with-icon">
                                                    ...
                                                    <input 
                                                        className="input-dark" 
                                                        placeholder={t('builder.whatsapp')}
