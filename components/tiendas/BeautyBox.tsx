  ...
  return (
    <div className="min-h-full bg-white font-sans text-[#000000] overflow-x-hidden selection:bg-black selection:text-white">
      ...
      <main className="w-full">
        ...
        {/* ─── BRANDS WE LOVE ─── */}
        <div className="max-w-[1400px] mx-auto px-4 lg:px-8 pb-16">
          <h2 className="text-[20px] md:text-[24px] font-bold mb-8">Brands We Love</h2>
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
            {['Fenty Beauty', 'Rare Beauty', 'Charlotte Tilbury', 'Drunk Elephant', 'Sol de Janeiro', 'NARS'].map((brand, i) => (
              <div key={i} className="bg-[#f6f6f8] rounded-[8px] p-6 flex items-center justify-center h-[80px] cursor-pointer hover:shadow-md transition-shadow group">
                <span className="text-[14px] font-bold text-gray-700 group-hover:text-black transition-colors text-center">{brand}</span>
              </div>
            ))}
          </div>
        </div>
