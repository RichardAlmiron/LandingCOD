  ...
  return (
    <div className="min-h-full bg-white font-sans text-black overflow-x-hidden selection:bg-black selection:text-white" style={{ fontFamily: "'Inter', 'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
        ...
        <div className="w-full px-4 md:px-8 h-[60px] md:h-[70px] flex items-center justify-between">
          ...
          <div className="flex items-center justify-end space-x-5 md:space-x-8 w-1/3">
            ...
            >
              ...
              {itemCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-black text-white text-[9px] font-bold w-4 h-4 rounded-full flex items-center justify-center">{itemCount}</span>
              )}
            </button>
          </div>
        </div>
      ...
      <main className="w-full pt-[60px] md:pt-[70px]">
        ...
        {/* ─── NEW SEASON LOOKBOOK ─── */}
        <div className="w-full px-4 md:px-10 py-24 md:py-32">
          <div className="text-center mb-16">
            <h3 className="text-[24px] md:text-[32px] font-black tracking-[0.2em] uppercase mb-4">New Season Lookbook</h3>
            <p className="text-[12px] md:text-[13px] font-medium tracking-wide text-gray-500 max-w-lg mx-auto">
              A visual journey through the latest collection. Architectural forms meet fluid silhouettes.
            </p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4">
            {[534, 535, 536, 537].map((seed) => (
              <div key={seed} className="relative aspect-[3/4] overflow-hidden group cursor-pointer bg-[#f4f4f4]">
                <Image src={`https://picsum.photos/600/800?random=${seed}`} alt="Lookbook" fill className="object-cover group-hover:scale-105 transition-transform duration-[1500ms]" />
        ...
        {/* ─── BRAND PHILOSOPHY ─── */}
        <div className="w-full bg-[#1a1a1a] text-white py-24 md:py-32 px-4 md:px-10">
          <div className="max-w-[900px] mx-auto text-center">
            <h3 className="text-[11px] font-bold uppercase tracking-[0.3em] text-gray-400 mb-6">Philosophy</h3>
            <h2 className="text-[28px] md:text-[40px] font-black tracking-[0.15em] uppercase mb-8 leading-tight">Thinking Fashion Since 1913</h2>
            <p className="text-[13px] md:text-[15px] font-medium tracking-wide leading-relaxed text-[#aaa] mb-12 max-w-2xl mx-auto">
              MilanoModern has always been about challenging conventions. From the first collection to today, the brand continues to redefine what luxury means through intellectual rigor, material innovation, and an unwavering commitment to craft.
            </p>
            <button className="border border-white px-10 py-3.5 text-[10px] font-bold tracking-[0.25em] uppercase hover:bg-white hover:text-black transition-colors duration-300">
              Our Heritage
            </button>
          </div>
        </div>
        ...
        <div className="w-full py-24 md:py-32 px-4 md:px-10">
          <div className="text-center mb-12">
            <h3 className="text-[11px] font-bold uppercase tracking-[0.3em] text-gray-400 mb-4">@MilanoModern</h3>
            <h2 className="text-[24px] md:text-[32px] font-black tracking-[0.2em] uppercase">Follow Us</h2>
          </div>
          <div className="grid grid-cols-3 md:grid-cols-6 gap-2 md:gap-3 max-w-[1920px] mx-auto">
            {[538, 539, 540, 541, 542, 543].map((seed) => (
              <div key={seed} className="relative aspect-square overflow-hidden group cursor-pointer">
                <Image src={`https://picsum.photos/400/400?random=${seed}`} alt="Instagram" fill className="object-cover group-hover:scale-110 transition-transform duration-700 grayscale group-hover:grayscale-0" />
        ...
        {/* ─── NEWSLETTER ─── */}
        <div className="w-full bg-[#e6eada] py-20 md:py-28 px-4 md:px-10 border-t border-gray-200">
          <div className="max-w-[600px] mx-auto text-center">
            <h3 className="text-[24px] md:text-[32px] font-black tracking-[0.2em] uppercase mb-4">Newsletter</h3>
            <p className="text-[13px] font-medium tracking-wide text-gray-600 mb-10">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 bg-white border border-gray-300 px-6 py-3.5 text-[12px] font-medium tracking-wider outline-none focus:border-black transition-colors"
              />
              <button className="bg-black text-white px-8 py-3.5 text-[10px] font-bold tracking-[0.2em] uppercase hover:bg-gray-800 transition-colors">
                Subscribe
              </button>
            </div>
          </div>
