        ...
        <div className="w-full mx-auto px-4 md:px-8 h-[60px] md:h-[72px] flex items-center justify-between">
          ...
          <div className="flex items-center justify-end space-x-6 md:space-x-8 w-1/3">
            ...
            >
              ...
              {itemCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-black text-white text-[9px] font-bold px-1.5 rounded-full">{itemCount}</span>
              )}
            </div>
          </div>
        </div>
      ...
      <main className="w-full">
        ...
        <div className="w-full max-w-[1920px] mx-auto px-4 md:px-12 py-24 md:py-32">
          <div className="text-center mb-16 flex flex-col items-center">
            <h3 className="text-[18px] md:text-[24px] font-bold tracking-[0.2em] uppercase mb-6">Latest from the House</h3>
            <div className="w-10 h-[2px] bg-black"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {[
              { title: "Spring-Summer Collection", subtitle: "A celebration of lightness and movement", img: "https://picsum.photos/900/600?random=201" },
              { title: "Métiers d'Art", subtitle: "The exceptional savoir-faire of the ateliers", img: "https://picsum.photos/900/600?random=202" },
            ].map((item, idx) => (
              <div key={idx} className="relative aspect-[3/2] overflow-hidden group cursor-pointer bg-gray-100">
                <Image src={item.img} alt={item.title} fill className="object-cover group-hover:scale-105 transition-transform duration-[2000ms] grayscale group-hover:grayscale-0" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-8 md:p-12 text-white">
                  <p className="text-[10px] font-bold tracking-[0.25em] uppercase mb-2 text-gray-300">{item.subtitle}</p>
                  <h4 className="text-[22px] md:text-[28px] font-bold tracking-[0.15em] uppercase mb-4">{item.title}</h4>
                  <span className="text-[10px] font-bold tracking-[0.2em] uppercase border-b border-white pb-1 group-hover:text-gray-300 group-hover:border-gray-300 transition-colors">
                    Discover
                  </span>
                </div>
              </div>
        ...
        {/* ─── INSTAGRAM FEED ─── */}
        <div className="w-full py-20 md:py-28 px-4 md:px-12">
          <div className="text-center mb-12 flex flex-col items-center">
            <h3 className="text-[10px] font-bold tracking-[0.3em] uppercase text-gray-400 mb-4">@ParisianChic</h3>
            <h2 className="text-[18px] md:text-[24px] font-bold tracking-[0.2em] uppercase">Follow the House</h2>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-2 md:gap-3 max-w-[1920px] mx-auto">
            {[203, 204, 205, 206, 207, 208].map((seed) => (
        ...
        {/* ─── NEWSLETTER ─── */}
        <div className="w-full bg-[#f2f2f2] py-20 md:py-28 px-4 md:px-12 border-t border-gray-200">
          <div className="max-w-[600px] mx-auto text-center">
            <h3 className="text-[18px] md:text-[24px] font-bold tracking-[0.2em] uppercase mb-4">Newsletter</h3>
            <p className="text-[13px] font-normal tracking-wide text-gray-500 mb-10">Subscribe to receive the latest news from the House of ParisianChic.</p>
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              />
              <button className="bg-black text-white px-8 py-3.5 text-[10px] font-bold tracking-[0.25em] uppercase hover:bg-gray-800 transition-colors">
                Subscribe
              </button>
            </div>
          </div>
