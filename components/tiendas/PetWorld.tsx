  ...
  return (
    <div className="min-h-full bg-white font-sans text-[#333333] selection:bg-[#001952] selection:text-white pb-10 overflow-x-hidden">
          ...
          <div className="flex items-center space-x-2 md:space-x-6 text-[#001952] shrink-0">
            ...
            >
              <div className="relative">
                ...
                {itemCount > 0 && (
                  <span className="absolute -top-1.5 -right-2 bg-[#e31837] text-white text-[11px] font-black w-[20px] h-[20px] flex items-center justify-center rounded-full leading-none border-2 border-white shadow-sm">{itemCount}</span>
                )}
              </div>
      ...
      <main className="w-full max-w-[1440px] mx-auto px-4 lg:px-8 py-6 md:py-10">
        ...
        {/* ─── ADOPTION CENTER ─── */}
        <div className="mb-16 md:mb-24 bg-gradient-to-r from-[#e31837] to-[#ff4d6a] text-white rounded-[16px] md:rounded-[24px] p-8 md:p-14 text-center">
          <h2 className="text-[32px] md:text-[40px] font-black mb-4 tracking-tight">PetWorld Love — Adopt a Pet</h2>
          <p className="text-[16px] md:text-[18px] font-medium text-white/90 mb-8 max-w-2xl mx-auto">
            Find your new best friend. We partner with local shelters to help pets find their forever homes. Over 6 million pets adopted through our stores.
          </p>
          <p className="text-[48px] font-black mb-6">6M+ Adopted</p>
          <button className="bg-white text-[#e31837] px-8 py-4 rounded-full font-black text-[15px] hover:bg-[#001952] hover:text-white transition-all shadow-lg">
        ...
        {/* ─── PET CARE ARTICLES ─── */}
        <div className="mb-16 md:mb-24">
          <h2 className="text-[28px] md:text-[36px] font-black text-[#001952] mb-8 tracking-tight">Pet Care Resources</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { title: "Puppy's First Year: A Complete Guide", img: "https://picsum.photos/600/400?random=527" },
              { title: "Best Cat Toys for Indoor Cats", img: "https://picsum.photos/600/400?random=528" },
              { title: "How to Set Up a Freshwater Aquarium", img: "https://picsum.photos/600/400?random=529" },
            ].map((article, i) => (
              <div key={i} className="group cursor-pointer bg-white border border-gray-200 rounded-[12px] overflow-hidden hover:shadow-lg transition-shadow">
                ...
                <div className="p-6">
                  <h3 className="text-[16px] font-black text-[#001952] mb-2 group-hover:underline">{article.title}</h3>
                  <span className="text-[14px] font-bold text-[#001952] flex items-center">Read Article <ArrowRight className="w-4 h-4 ml-1" /></span>
                </div>
              </div>
            ))}
          </div>
        ...
        {/* ─── CUSTOMER REVIEWS ─── */}
        <div className="mb-16 md:mb-24 bg-[#f0f4f8] rounded-[16px] p-8 md:p-12">
          <h2 className="text-[28px] md:text-[36px] font-black text-[#001952] mb-8 text-center tracking-tight">What Pet Parents Say</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { name: "Jennifer L.", text: "Same-day delivery is a lifesaver when you run out of dog food. PetWorld never disappoints!", rating: 5 },
              { name: "David M.", text: "The grooming service is fantastic. My poodle always comes out looking amazing.", rating: 5 },
              { name: "Amanda S.", text: "Vital Care membership pays for itself. The vet visits alone are worth it.", rating: 5 },
            ].map((review, i) => (
              <div key={i} className="bg-white rounded-[12px] p-6 shadow-sm">
                ...
                <span className="text-[14px] font-black text-[#001952]">{review.name}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mb-10 text-center">
          <h2 className="text-[28px] md:text-[36px] font-black text-[#001952] mb-4 tracking-tight">Stay Connected</h2>
          <p className="text-[15px] text-gray-600 mb-8 max-w-md mx-auto">Sign up for exclusive offers, pet care tips, and new product alerts.</p>
          <div className="flex flex-col sm:flex-row gap-3 max-w-[500px] mx-auto">
            <input type="email" placeholder="Email Address" className="flex-1 bg-[#f0f4f8] border-2 border-[#001952] px-6 py-3.5 rounded-full outline-none focus:border-[#e31837] transition-colors font-bold" />
            <button className="bg-[#e31837] text-white px-8 py-3.5 rounded-full font-black hover:bg-[#001952] transition-colors">Subscribe</button>
          </div>
        </div>
