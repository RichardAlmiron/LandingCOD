        ...
        <div className="w-full mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-8">
            ...
            >
              ...
              {itemCount > 0 && (
                <span className="absolute top-0 right-0 bg-[#e1251b] text-white text-[10px] font-bold px-1.5 rounded-full">{itemCount}</span>
              )}
            </div>
          </div>
        </div>
      ...
      <main className="w-full mx-auto px-6 py-8">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { name: "Chen W.", text: "Fast delivery and authentic products. PrimeGoods never disappoints!", rating: 5 },
              { name: "Li M.", text: "The flash deals are incredible. Got a 4K TV at half price.", rating: 5 },
              { name: "Zhang Y.", text: "Best customer service. They resolved my issue within hours.", rating: 5 },
            ].map((review, i) => (
        ...
        <div className="mb-16">
          <div className="flex items-center justify-between mb-8 border-b-2 border-[#e1251b] pb-4">
            <h2 className="text-2xl font-black uppercase tracking-tight">Official Brand Partners</h2>
          </div>
          <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
            {['Samsung', 'Apple', 'Nike', 'Dyson', 'Sony', 'Huawei'].map((brand, i) => (
              <div key={i} className="bg-white rounded-lg p-6 flex items-center justify-center border border-gray-200 hover:shadow-md transition-shadow cursor-pointer h-20">
                <span className="font-black text-lg text-gray-300 hover:text-[#e1251b] transition-colors">{brand}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* New User Promo */}
        <div className="mb-16 bg-gradient-to-r from-[#e1251b] to-[#f74a4a] rounded-2xl p-8 md:p-12 text-white text-center">
          <h2 className="text-3xl font-black uppercase tracking-tighter mb-4">New User? Get $50 Off!</h2>
          <p className="text-lg font-medium text-white/90 mb-8 max-w-xl mx-auto">
            Register now and receive a $50 welcome coupon plus free shipping on your first order.
          </p>
          <button className="bg-white text-[#e1251b] px-10 py-4 rounded-lg font-black uppercase text-lg hover:bg-gray-100 transition-colors shadow-xl">
            Register Now
          </button>
        </div>
        ...
        <div className="mb-16 text-center">
          <h2 className="text-2xl font-black uppercase tracking-tight mb-4">Stay Connected</h2>
          <p className="text-sm text-gray-500 mb-6">Subscribe for exclusive deals and new product launches.</p>
          <div className="flex flex-col sm:flex-row gap-3 max-w-[500px] mx-auto">
            <input type="email" placeholder="Email Address" className="flex-1 border-2 border-[#e1251b] px-6 py-3 rounded-sm outline-none font-bold" />
            <button className="bg-[#e1251b] text-white px-8 py-3 rounded-sm font-black uppercase hover:bg-black transition-colors">Subscribe</button>
          </div>
        </div>
