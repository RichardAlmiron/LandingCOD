  ...
  return (
    <div className="min-h-full bg-white font-sans text-[#1b1b1b] selection:bg-[#ff0000] selection:text-white pb-0 overflow-x-hidden">
        ...
        <div className="max-w-[1440px] mx-auto px-4 lg:px-6 h-[72px] flex items-center justify-between">
          ...
          <div className="flex items-center space-x-5 lg:space-x-8 text-[#1b1b1b]">
            ...
            >
              ...
              {itemCount > 0 && (
                <span className="absolute top-0 right-0 md:right-1 bg-[#ff0000] text-white text-[9px] font-bold px-1.5 rounded-full">{itemCount}</span>
              )}
      ...
      <main className="w-full">
        ...
        {/* ─── LIFEWEAR PHILOSOPHY ─── */}
        <section className="max-w-[1440px] mx-auto px-4 lg:px-6 py-20">
          <div className="flex flex-col md:flex-row gap-10 items-center">
            <div className="w-full md:w-1/2 relative aspect-[4/3] overflow-hidden">
              <Image src="https://picsum.photos/800/600?random=820" alt="LifeWear" fill className="object-cover" />
            </div>
            <div className="w-full md:w-1/2 text-center md:text-left">
              <span className="text-[#ff0000] text-[12px] font-bold uppercase tracking-widest mb-3 block">Our Philosophy</span>
              <h2 className="text-[32px] md:text-[44px] font-black uppercase tracking-tight leading-none mb-6 text-[#1b1b1b]">LifeWear</h2>
              <p className="text-[15px] text-gray-600 leading-relaxed mb-8">Clothing designed to make everyone's life better. Simple, high-quality, everyday clothing with a practical sense of beauty — LifeWear is made for all.</p>
              <button className="bg-[#1b1b1b] text-white px-10 py-4 font-bold text-[13px] uppercase tracking-widest hover:bg-gray-800 transition-colors">Discover More</button>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-16 border-y border-gray-200">
          <div className="max-w-[1440px] mx-auto px-4 lg:px-6">
            <h2 className="text-[24px] md:text-[32px] font-black uppercase tracking-tight text-center mb-10">Customer Reviews</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { name: 'Emily R.', text: 'The quality for the price is unbeatable. My go-to for basics.', rating: 5 },
                { name: 'David K.', text: 'AIRism is a game changer. So comfortable in summer heat.', rating: 5 },
                { name: 'Lisa M.', text: 'Love the minimalist designs. Perfect for building a capsule wardrobe.', rating: 4 },
              ].map((review, i) => (
                <div key={i} className="border border-gray-200 p-8 flex flex-col">
                  ...
                  <span className="font-bold text-[13px] text-[#1b1b1b]">{review.name}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* ─── NEWSLETTER SIGNUP ─── */}
        <section className="max-w-[800px] mx-auto px-4 py-20 text-center">
          <h2 className="text-[24px] md:text-[32px] font-black uppercase tracking-tight mb-4">Get $10 Off</h2>
          <p className="text-[14px] text-gray-600 mb-8">Download the ZenBasic app and sign up for our newsletter to receive $10 off your first order.</p>
          <form className="flex w-full max-w-lg mx-auto">
            ...
            <button type="button" className="bg-[#ff0000] text-white px-8 py-3 font-bold uppercase tracking-widest text-[13px] hover:bg-red-600 transition-colors shrink-0">Subscribe</button>
          </form>
        </section>
