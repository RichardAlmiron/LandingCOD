        ...
        <div style={{ display: 'flex', height: '100vh', width: '100vw', overflow: 'hidden', position: 'relative' }}>
            ...
            <aside className="ultra-glass" style={{
                ...
                <div style={{ padding: '12px', borderTop: '1px solid rgba(255,255,255,0.06)', flexShrink: 0, position: 'relative', zIndex: 1 }}>
                    <Link href="/settings" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none', padding: '8px 10px', borderRadius: 10, marginBottom: 8 }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                            <div style={{ fontSize: 13, fontWeight: 700, color: '#fff', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>{user?.name ?? 'Usuario'}</div>
                ...
                <header className="ultra-glass" style={{
                    ...
                    <div style={{ position: 'relative', zIndex: 1 }}>
                        <h1 style={{ fontSize: 16, fontWeight: 800, color: '#fff', letterSpacing: '-0.01em', margin: 0 }}>
                            {pathname === '/dashboard' ? 'Dashboard' : pathname === '/builder' ? 'Builder' : pathname === '/settings' ? 'Configuración' : 'LandingCOD'}
                        </h1>
                    </div>
