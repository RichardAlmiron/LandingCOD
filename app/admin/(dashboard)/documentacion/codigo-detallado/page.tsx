...
const ARCHIVOS: Archivo[] = [
    ...
    },
    {
        ...
        que_hace_exactamente: 'Recibe la lista original, el tab activo y las categorías. Mantiene en estado: búsqueda de texto, filtro de estado (todos/verificados/pendientes), filtro de categoría y filtro de subcategoría. Calcula con useMemo la lista filtrada aplicando todos los filtros en cadena. Expone clearFilters() para resetear todo.',
        que_NO_hace: 'No sabe de dónde vienen los datos. No hace fetch. No ejecuta acciones. No sabe de selección. Solo filtra.',
        funciones: [
            { nombre: 'useTemplateFilters(list, tab, categorias)', que_hace: 'Hook principal. Recibe la lista cruda, el tab activo y las categorías disponibles.', devuelve: '{ search, setSearch, estadoFiltro, setEstadoFiltro, categoriaFiltro, setCategoriaFiltro, subcategoriaFiltro, setSubcategoriaFiltro, filtered, clearFilters }' },
            { nombre: 'filtered (useMemo)', que_hace: 'Aplica en cadena: filtro de texto → filtro de estado → filtro de categoría → filtro de subcategoría. Devuelve solo los items que pasan todos los filtros.' },
            { nombre: 'clearFilters()', que_hace: 'Resetea search="", estadoFiltro="todos", categoriaFiltro="", subcategoriaFiltro="".' },
        ],
        departamento: 'Dirección Creativa',
        deptColor: '#6366f1',
    },
    {
        ...
        funciones: [
            ...
            { nombre: 'doAssignCategory(itemId, catId, subId)', que_hace: 'Llama templatesApi.assignCategory(). Luego onMutate() para refrescar.' },
        ],
        departamento: 'Dirección Creativa',
        deptColor: '#6366f1',
    },
    {
        ...
        funciones: [
            { nombre: 'useCategorias()', que_hace: 'Hook principal. Hace fetch al montar, guarda categorías en useState.', devuelve: '{ categorias: CategoriaConSubcategorias[] }' },
        ],
        departamento: 'Dirección Creativa',
        deptColor: '#6366f1',
    },
    ...
    },
    {
        ...
        funciones: [
            ...
            { nombre: 'assignCategory(itemId, catId, subId)', que_hace: 'POST a /api/categorias-pdp con accion="asignar_categoria".', devuelve: 'boolean' },
